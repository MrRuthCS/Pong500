...
## The Code
Uses two webcams, each trained on 250 students sitting in the bleachers in our high school gymnasium and OpenCV-python to capture video frames. 
They are analyzed by counting the pixels in each of 250 rectangular slices
